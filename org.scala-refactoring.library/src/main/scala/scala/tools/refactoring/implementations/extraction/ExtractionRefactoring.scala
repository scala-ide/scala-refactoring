...
trait ExtractionRefactoring extends MultiStageRefactoring
  with CompilerAccess with Abstractions with InsertionPositions with VisibilityScopes with ReplaceableSelections {
  import global._
