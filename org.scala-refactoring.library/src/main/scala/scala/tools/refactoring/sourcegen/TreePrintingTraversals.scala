  ...
  trait TreePrinting {
    ...
    def dispatchToPrinter(t: Tree, ctx: PrintingContext): Fragment = context("Printing Tree "+ t.getClass.getSimpleName) {
      ...
      val code = t match {
        ...
        case tree @ TypeTreeWithDeferredRefCheck() => printer.TypeTreeWithDeferredRefCheck(tree)
    ...
    def default(t: Tree)(implicit ctx: PrintingContext): Fragment = Predef.error("Not implemented!")
    ...
    def TypeTreeWithDeferredRefCheck(tree: TypeTreeWithDeferredRefCheck)(implicit ctx: PrintingContext): Fragment = default(tree)
