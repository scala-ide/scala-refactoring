...
In the remainder of this chapter, the three library components will be explained in more detail. %Keep in mind that the shown functionality is not meant to be feature complete but can and will be extended as seen fit. %gehört das hier hin? was ist mit dem common paket?
