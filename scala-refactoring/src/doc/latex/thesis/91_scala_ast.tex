...
\noindent \src{For} or sequence comprehensions are a purely syntatic construct; in the AST, they are represented with \src{foreach}, \src{filter}, \src{map}, and \src{flatMap} calls. The following listing shows some examples. 
