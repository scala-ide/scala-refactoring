...
The IDE implementation distinguishes between two different modes: inline renaming as shown in \figref{figure:rename-screenshot-1} and the traditional dialog based implementation in \figref{figure:rename-screenshot-2}.
...
\begin{figure}
  ...
  % organize_screenshot_1.png: 960x635 pixel, 96dpi, 25.40x16.80 cm, bb=0 0 720 476
